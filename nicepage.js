    ...
    !(function (a, factory) {
      ...
      return function (t, e, items, i) {
        ...
        var u = function () {
          ...
          Tt = function () {
            if ((n.bind(document, "keydown", o), nt.transform))
          ...
          Ot = function (t, e, i, n) {
            if (n === o.currItem.initialZoomLevel)
              return (i[t] = o.currItem.initialPosition[t]), true;
            else if (((i[t] = wt(t, n)), i[t] > e.min[t]))
          ...
          Wt = {
            ...
            init: function () {
              if (!f && !c) {
                ...
                if (
                  ...
                  h = 0;
                if (((o.currItem = bi(h)), nt.isOldIOSPhone || nt.isOldAndroid))
                  Z = false;
                ...
                if (void 0 === tt)
                  ct("initialLayout"), (tt = Y = n.getScrollY());
                var u = "pswp--open ";
            ...
            destroy: function () {
              ...
              if ((t.setAttribute("aria-hidden", "true"), (t.className = K), I))
                clearInterval(I);
            ...
            updateSize: function (e) {
              ...
              if (
                ...
                (w.x = xe.center.x), (w.y = xe.center.y), mt(true);
              ct("resize");
            },
          ...
          Ve = function (t, e) {
            return (
              (Ue.prevent = !We(t.target, l.isClickableElement)),
            ...
            if (!V)
              if (t.type.indexOf("touch") > -1) {
                if (t.touches && t.touches.length > 0)
                  if (((Ye[0] = Ze(t.touches[0], Ge)), t.touches.length > 1))
                    Ye[1] = Ze(t.touches[1], Ke);
              } else
                (Ge.x = t.pageX), (Ge.y = t.pageY), (Ge.id = ""), (Ye[0] = Ge);
            else
              (Qe = 0),
            ...
            if (ye) {
              ...
              if (0 !== t)
                if (
                  ...
                  if (!Ie) return;
                  if (Ee) {
                    if (((Ee = false), Math.abs(Gt.x) >= Vt))
                      Gt.x -= ye[0].x - Yt.x;
                    if (Math.abs(Gt.y) >= Vt) Gt.y -= ye[0].y - Yt.y;
                  }
                  if (((Kt.x = Xt.x), (Kt.y = Xt.y), 0 === Gt.x && 0 === Gt.y))
                    return;
          ...
          publicMethods: {
            initGestures: function () {
              ...
              if (V)
                ...
                t("touch", "start", "move", "end", "cancel"), (j = true);
        ...
        var ci,
          ...
          Si = function (t, e, i) {
            if (t.src && !t.loadError) {
              ...
              if (!i) return;
              if ((Ti(t, t.w * i, t.h * i), n && i === t.initialZoomLevel))
          ...
          Li = function () {
            if (mi.length) {
              for (var t, e = 0; e < mi.length; e++)
                if (((t = mi[e]), t.holder.index === t.index))
                  ki(
                    t.index,
                    t.item,
                    t.baseDiv,
            ...
            onTapRelease: function (t, e) {
              if (e)
                if (!pe && !fe && !Rt) {
                  var i = e;
                  if (Oi)
                    if ((clearTimeout(Oi), (Oi = null), Pe(i, Di)))
          ...
          publicMethods: {
            ...
            setupDesktopZoom: function (e) {
              ...
              if (
                ...
                ft("pointerDown", function () {
                  if (o.mouseZoomedIn)
                    (i = true), n.addClass(t, "pswp--dragging");
                }),
                ft("pointerUp", s),
                !e)
              )
            ...
            handleMouseWheel: function (t) {
              ...
              if ((t.stopPropagation(), (zi.x = 0), "deltaX" in t))
                if (1 === t.deltaMode)
                  (zi.x = 18 * t.deltaX), (zi.y = 18 * t.deltaY);
                else (zi.x = t.deltaX), (zi.y = t.deltaY);
              else if ("wheelDelta" in t) {
                if (t.wheelDeltaX) zi.x = -0.16 * t.wheelDeltaX;
                if (t.wheelDeltaY) zi.y = -0.16 * t.wheelDeltaY;
                else zi.y = -0.16 * t.wheelDelta;
        ...
        var Pi = { history: true, galleryUID: 1 },
          Ri,
          Ni,
          Hi,
          Bi,
            ...
            initHistory: function () {
              if ((n.extend(l, Pi, true), l.history)) {
                if (
                  ...
                  (Ui = Ui.split("&gid=")[0]), (Ui = Ui.split("?gid=")[0]);
                ...
                if (index > -1)
                  if (((Ui = Ui.substring(0, index)), "&" === Ui.slice(-1)))
                    Ui = Ui.slice(0, -1);
                setTimeout(function () {
